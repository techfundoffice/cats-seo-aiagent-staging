...
<meta
  name="description"
  content="[Brand] helps [audience] [achieve goal]. [Key feature/benefit]. [CTA]"
/>
```
...
<meta
  name="description"
  content="[Product] [key features]. [Price/offer if applicable]. [Social proof]. [CTA]"
/>
```
...
<meta
  name="description"
  content="[What they'll learn]. [Key points covered]. [CTA]"
/>
```
...
<meta
  name="description"
  content="[Service description]. [Experience/credentials]. [Key benefit]. [CTA]"
/>
```
