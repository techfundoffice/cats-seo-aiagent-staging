    ...
    >
      <div style={{ maxWidth: "56rem", margin: "0 auto" }}>
        ...
        <div style={{ marginBottom: "0.75rem" }}>
          <a
            href="https://github.com/techfundoffice/cats-seo-aiagent-staging"
            target="_blank"
            rel="noopener"
            style={{
              fontSize: "0.8rem",
          ...
          >
            ...
            techfundoffice/cats-seo-aiagent-staging
          </a>
        </div>
                ...
                >
                  ...
                  {(prMatch || shaMatch) && (
                    ...
                    >
                      {prMatch && (
                        <a
                          href={`https://github.com/techfundoffice/cats-seo-aiagent-staging/pull/${prMatch[1]}`}
                          target="_blank"
                          rel="noopener noreferrer"
                          style={{
                            color: "#2563eb",
                      ...
                      {shaMatch && (
                        <a
                          href={`https://github.com/techfundoffice/cats-seo-aiagent-staging/commit/${shaMatch[1]}`}
                          target="_blank"
                          rel="noopener noreferrer"
                          style={{
                            color: "#2563eb",
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          cats-seo-aiagent-staging Activity Monitor
          <span
            style={{
              marginLeft: "0.5rem",
              fontSize: "0.75rem",
      ...
      >
        ...
        <div>
          <div style={headerStyle}>
            <StatusDot status={ghDot} />
            GitHub — cats-seo-aiagent-staging
          </div>
